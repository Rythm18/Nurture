...
<body>
    ...
    <div class="container1 b-container" id="b-container">
        <form class="form" id="b-form" method="post" action="login.php">
          ...
          <input class="form__input" type="email" placeholder="Email" name="uname">
          <input class="form__input" type="password" placeholder="Password" name="password">
          <!-- <a class="form__link">Forgot your password?</a> -->
          <input type="submit" class="form__button button submit" value="SIGN IN"  >
    ...
    <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          ...
          <p class="switch__description description">To keep connected with us please Sign Up Here with your personal info</p>
          <a href="signup.php"><button class="switch__button button switch-btn">SIGN UP</button></a>
        </div>
